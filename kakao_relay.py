...
def _render_card_file(cfg, card):
    """카드 이미지를 그려 경로를 돌려줍니다. 실패하면 None."""
    if not card:
        return None
    try:
        from card_render import render_card
